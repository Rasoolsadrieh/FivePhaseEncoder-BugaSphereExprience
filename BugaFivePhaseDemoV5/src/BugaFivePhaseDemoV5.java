...
public class BugaFivePhaseDemoV5 {
    ...
    enum BreathMode {
        INHALE_6, // Inhale 6s (0,1,2) | Exhale 4s (3,4)
        INHALE_8  // Inhale 8s (0,1,2,3) | Exhale 2s (4)
    }
    ...
    static class Panel extends JPanel {
        ...
        @Override protected void paintComponent(Graphics g){
            ...
            if (showHud) {
                ...
                String hint = "Click a mode button • F11 = Fullscreen • SPACE = Pause • ←/→ = Prev/Next • H = Toggle HUD • ESC = Quit";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame f = new JFrame("Five-Phase Encoder — V5 (Mode Buttons)");
            ...
            // Top: mode buttons (clear, always visible)
            JPanel controls = new JPanel() {
                @Override protected void paintComponent(Graphics g) {
                    // semi-translucent backdrop so buttons are readable on any color
                    Graphics2D g2 = (Graphics2D) g.create();
            ...
            // make buttons not steal keyboard focus (so space/arrow keys still work)
            ...
            // Button actions: update mode immediately
            ...
            f.addKeyListener(new KeyAdapter() {
                @Override public void keyPressed(KeyEvent e) {
                    switch (e.getKeyCode()) {
                        ...
                        case KeyEvent.VK_6:      btn6.doClick(); break; // keep hotkeys too
            ...
            Thread loop = new Thread(() -> {
                ...
                try {
                    ...
                    while (f.isDisplayable()) {
                        ...
                        // Pick INHALE/EXHALE by mode + phase
    ...
    private static boolean isInhale(BreathMode mode, int phaseIndex){
        switch (mode) {
            case INHALE_6: return (phaseIndex == 0 || phaseIndex == 1 || phaseIndex == 2);
            case INHALE_8: return (phaseIndex == 0 || phaseIndex == 1 || phaseIndex == 2 || phaseIndex == 3);
            default:       return true;
        }
    }
}
